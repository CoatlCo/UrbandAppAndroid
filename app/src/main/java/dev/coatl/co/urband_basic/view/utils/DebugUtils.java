...
public class DebugUtils {
	...
	public static void logInfo(String logClass, String method, String text) {
		if (DEBUG)
			Log.i(logClass+" :: "+String.valueOf(method), String.valueOf(text));
	}
	...
	public static void logError(String logClass, String method, String text) {
		if (DEBUG)
			Log.e(logClass+" :: "+String.valueOf(method), String.valueOf(text));
	}
	...
	public static void logDebug(String logClass, String method, String text) {
		if (DEBUG)
			Log.d(logClass+" :: "+String.valueOf(method), String.valueOf(text));
	}
